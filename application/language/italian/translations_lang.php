...
$lang['about_app_support'] = 'Se riscontri un problema quando utilizzi Easy!Appointments puoi cercare sul Gruppo Google ufficiale per le risposte. Potresti anche aver bisogno di creare una nuova segnalazione sulla pagina Google Code al fine di aiutarci negli sviluppi futuri.';
...
$lang['book_appointment_title'] = 'Prenota un appuntamento';
...
$lang['login_failed'] = 'Autenticazione fallita, per favore inserisci le credenziali corrette e prova ancora.';
...
$lang['first_weekday_hint'] = 'Imposta il primo giorno della settimana.';
...
$lang['require_phone_number_hint'] = 'Se abilitato, i clienti e gli amministratori dovranno inserire il numero di telefono quando prenotano un appuntamento';
$lang['check_spam_folder'] = 'Per favore controlla la tua cartella spam se non ricevi l\'email di conferma entro qualche minuto.';
$lang['api_token_hint'] = 'Imposta un token segreto per abilitare il token di autenticazione dell\'API di Easy!Appointments.';
$lang['timezone'] = 'Fuso orario';
$lang['overwrite_existing_working_plans'] = 'Questa azione sovrascriverà i piani di lavoro dei provider esistenti, sei sicuro di voler continuare?';
$lang['working_plans_got_updated'] = 'Tutti i piani lavoro sono stati aggiornati.';
$lang['apply_to_all_providers'] = 'Applica a tutti i fornitori';
$lang['display_any_provider'] = 'Mostra le impostazioni di ciascun fornitore';
$lang['display_any_provider_hint'] = 'Verrà aggiunta un\'opzione alla pagina di prenotazione che permette ai clienti di prenotare un servizio senza specificare un fornitore.';
